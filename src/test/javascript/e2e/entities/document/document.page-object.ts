...
export class DocumentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('mayaApp.document.delete.question'));
...
export default class DocumentComponentsPage {
  ...
  async deleteDocument() {
    ...
    expect(await documentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/mayaApp.document.delete.question/);
