...
/**
 * REST controller for managing {@link com.startupsreactor.maya.domain.Document}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Document> result = documentRepository
            ...
            .map(existingDocument -> {
                ...
                if (document.getContactId() != null) {
                    existingDocument.setContactId(document.getContactId());
                }
                if (document.getInputs() != null) {
                    existingDocument.setInputs(document.getInputs());
                }
                if (document.getIs_deleted() != null) {
                    existingDocument.setIs_deleted(document.getIs_deleted());
                }
                if (document.getIsenabled() != null) {
                    existingDocument.setIsenabled(document.getIsenabled());
                }
