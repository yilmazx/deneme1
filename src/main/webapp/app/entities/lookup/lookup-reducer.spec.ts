...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lookup.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOOKUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOOKUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOOKUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOOKUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOOKUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOOKUP actions', async () => {
      const expectedActions = [
        {
