...
export const LookupDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mayaApp.lookup.delete.question">
        <Translate contentKey="mayaApp.lookup.delete.question" interpolate={{ id: lookupEntity.id }}>
