...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTARTICLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCUMENTARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCUMENTARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCUMENTARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCUMENTARTICLE actions', async () => {
      const expectedActions = [
        {
