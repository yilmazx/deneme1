...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTARTICLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTARTICLE actions', async () => {
      const expectedActions = [
        {
