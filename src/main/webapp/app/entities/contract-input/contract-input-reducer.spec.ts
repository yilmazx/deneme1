...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTINPUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTINPUT actions', async () => {
      const expectedActions = [
        {
